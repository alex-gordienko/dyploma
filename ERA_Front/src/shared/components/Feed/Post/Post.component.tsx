...
import { ButtonBlock, Delimeter } from "../../EditorComponents/EditorComponents.styled";
...
const Post = (mode: IPostProps) => {
  ...
  const createComment = () =>{
    console.log(comment);
    if(mode.type==="FullPost" && comment!="") mode.onCreateComment(comment);
      ...
      <Footer>
        <Comments>
          {<Input
            ...
            postpendComponent={
              <ButtonBlock>
                <div className="label-button" onClick={createComment}>Create</div>
              </ButtonBlock>
            }
          />}
          {mode.comments?
                ...
                return(
                  ...
                  <div className="blocks">
                    ...
                    <div className="right-block">
                      ...
                      <div className="data">
                        <div className="head">
                            <NavLink className="username" to={"/profile/"+comment.author}>
                              {comment.author}
                            </NavLink>
