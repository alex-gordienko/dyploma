...
const FilterComponent = ({contries, cities, filters, letSearch}:IFilterComponentProps) => {
  return (
    <StyledFilters>
      <Header>
        <FilterIcon />
      ...
      <Filters filters={filters} contries={contries} cities={cities} letSearch={letSearch}/>
    </StyledFilters>
  );
}
