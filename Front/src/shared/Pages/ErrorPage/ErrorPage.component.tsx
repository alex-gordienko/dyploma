...
type IErrorPageProps =
  | IErrorPageServerProps
  | IErrorPageBannedProps
  | IErrorPageNotValidProps;
    ...
    case "nonValid": {
      return (
        <ErrorPageBlock>
          <Photo src={UserErr} />
          <Error>
            Sorry, user {mode.user.username} is not activated.
            <br />
            (Send message again/Change e-mail){" "}
          </Error>
        </ErrorPageBlock>
      );
    }
    case "banned": {
      return (
        <ErrorPageBlock>
          <Photo src={UserErr} />
          <Error>
            Sorry, user {mode.user.username} is banned.
            <br />
            Reason: {mode.reason}{" "}
          </Error>
        </ErrorPageBlock>
